    ...
    <footer className="bg-[#1f1f1f] text-gray-300 pt-16 pb-8 text-sm">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center space-x-4 mb-12">
          <a href="https://facebook.com/gurukul.org" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#90191b] flex items-center justify-center text-white hover:bg-white hover:text-[#90191b] transition duration-300 shadow-md">
          ...
          <a href="https://instagram.com/gurukul_org" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#90191b] flex items-center justify-center text-white hover:bg-white hover:text-[#90191b] transition duration-300 shadow-md">
          ...
          <a href="https://youtube.com/gurukulevents" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#90191b] flex items-center justify-center text-white hover:bg-white hover:text-[#90191b] transition duration-300 shadow-md">
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
          ...
          <a href="https://twitter.com/gurukul_org" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-[#90191b] flex items-center justify-center text-white hover:bg-white hover:text-[#90191b] transition duration-300 shadow-md">
            {/* Custom X Icon */}
            <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor">
