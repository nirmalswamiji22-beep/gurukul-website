    ...
    <div id="main-container" className="academics-inner bg-[#fef3de] pt-32 pb-16">
      ...
      <section className="about-section mb-16">
        <div className="container mx-auto px-4">
          <div className="row col-sec mb-0 flex flex-wrap -mx-4 items-center">
            <div className="col-lg-8 w-full lg:w-2/3 px-4 mb-8 lg:mb-0">
              <div className="about-content text-lg text-gray-700 leading-relaxed space-y-4">
                <h2 className="h2-common text-2xl lg:text-3xl font-bold text-[#1f1f1f] mb-6 leading-snug">
                  How is Swaminarayan Gurukul different from other International Schools?
                </h2>
                <p className="font-semibold text-gray-800">Is there a difference between Land and Nation? House and Home? Boy and Son?</p>
      ...
      {/* Tri-Fold Value System Introduction */}
      <div className="header-section pt-5 text-center mb-16 px-4">
        <h3 className="main-heading text-3xl font-extrabold text-[#cc0000] mb-2">Vidya, Sadvidya &amp; Brahmavidya</h3>
        <p className="sub-heading text-xl text-gray-600 mb-4 font-medium">Framework of Our Value System</p>
        <p className="sanskrit-title">|| सा विद्या या विमुक्तये ||</p>
        <p className="sanskrit-translation">Knowledge is one that liberates</p>
      </div>
      ...
      <section className="value-system-body container mx-auto px-4 mb-24">
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="value-card">
            <h3>Vidya</h3>
            <h4>Modern Education</h4>
            <ul className="value-list space-y-3">
              <li><span className="font-bold text-[#1f1f1f]">Dynamism:</span> Confidence, Courage, Proactiveness, Agility, Motivation, Discipline, Teamwork, Competition, Challenges</li>
              <li><span className="font-bold text-[#1f1f1f]">Curiosity:</span> Learning, Analyzing, Practicing, Experimenting &amp; Challenging, Inquisitiveness, Exploring, Exposure</li>
              <li><span className="font-bold text-[#1f1f1f]">Ambition:</span> Wisdom, Comprehension, Discernment</li>
              <li><span className="font-bold text-[#1f1f1f]">Creativity:</span> Out-of-the-box thinking, Imagination, Skills, Music, Arts, Performances, Technical expertise</li>
              <li><span className="font-bold text-[#1f1f1f]">Leadership:</span> Burning Vision, Inspiring others, Responsibility, Constructive use of Power</li>
            </ul>
          </div>
          ...
          <div className="value-card">
            ...
            <ul className="value-list space-y-3">
              <li><span className="font-bold text-[#1f1f1f]">Empathy:</span> Compassion, Recognizing emotions, Sympathy, Helping</li>
              <li><span className="font-bold text-[#1f1f1f]">Non violence:</span> Vegetarianism, सर्वे भवन्तु सुखिन: Social Harmony</li>
              <li><span className="font-bold text-[#1f1f1f]">Gratitude:</span> Caring Natural Resources, Acknowledgement, Contribution, मातृ देवो भव Respect, Patriotism</li>
              <li><span className="font-bold text-[#1f1f1f]">Integrity:</span> सत्यं वद, धर्मं चर। Moral Practices, Positive Attitude, Honesty, Truthfulness, Emotional Balance</li>
              <li><span className="font-bold text-[#1f1f1f]">Free from Bad Habits:</span> Right use of Media, Addiction free living</li>
            </ul>
          </div>
          ...
          <div className="value-card">
            ...
            <ul className="value-list space-y-3">
              <li><span className="font-bold text-[#1f1f1f]">Non Attachment:</span> Beyond material gratification, Self-control, Balance in Success &amp; Failure</li>
              <li><span className="font-bold text-[#1f1f1f]">Devotion:</span> तदर्पित अखिलाचारता Total Dedication, नवधा भक्ति, अखंडस्मृति, सेवा मुक्तिश्च गम्यताम्</li>
              <li><span className="font-bold text-[#1f1f1f]">Self realization:</span> Self-purification, निजात्मानं ब्रह्मरुपं। Discerning between Body &amp; Soul, Self-introspection</li>
              <li><span className="font-bold text-[#1f1f1f]">Deep Affection with Saints:</span> तत् सुखे सुखीत्वम्। तत् दुःखे दुःखीत्वम्।, कार्यः संङ्गोन्वहं सताम्। Source of Inspiration, Value Transmission</li>
              <li><span className="font-bold text-[#1f1f1f]">God Realization:</span> Conviction in manifested God, जन्माद्यस्य यतः Recognition, Experiencing, God-centric Choice, Allegiance</li>
              <li><span className="font-bold text-[#1f1f1f]">Faith:</span> Unwavering Belief in God, Adherence to Scriptures &amp; Tradition</li>
            </ul>
          </div>
      ...
      {/* Holistic Framework Details */}
      <section className="about-section pt-4 mb-16">
        <div className="container mx-auto px-4">
          <div className="row col-sec mb-0 flex flex-wrap -mx-4 items-center flex-row-reverse">
            <div className="col-lg-8 w-full lg:w-2/3 px-4 mb-8 lg:mb-0">
              <div className="about-content text-lg text-gray-700 leading-relaxed space-y-4">
                <h2 className="text-2xl lg:text-3xl font-bold text-[#1f1f1f] mb-6">Framework of Swaminarayan Gurukul Value System</h2>
                <p>Holistic Development of the child in 21st century is challenging in itself. At Shree Swaminarayan Gurukul International Schools, we deeply understand that today’s parents are worried and equally confused about their child’s holistic development.</p>
                <p className="font-semibold text-gray-800">Few concerns of child development…</p>
                <ul className="list-disc pl-6 space-y-2 text-gray-600">
                  <li>Why such a mad-rush for Marks &amp; Ranks, can they actually judge my child?</li>
                  <li>Aren’t we pressurizing our kids &amp; killing their hidden skills, talent &amp; creativity in competition?</li>
                  <li>Why can’t we equally focus on Extra-curricular activities &amp; Sports, has that nothing to do with his future?</li>
      ...
      {/* Subsection 1: Vidya Detail Grid */}
      <section className="adv-section mb-16 pt-8">
        <div className="container mx-auto px-4">
          <div className="row flex flex-wrap -mx-4 items-center">
            ...
            <div className="col-lg-8 w-full lg:w-2/3 px-4">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#cc0000] mb-4">1. Vidya – Modern Education</h2>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { img: "Creativity.svg", title: "Creativity", desc: "Cultivating innovative thinking and problem-solving skills, encouraging originality and inventive solutions" },
                  { img: "leadership.svg", title: "Leadership", desc: "Developing responsible, ethical leaders who are prepared to make positive contributions to society" },
                  ...
                  >
                    ...
                    <div>
                      <h4 className="font-bold text-[#1f1f1f] text-lg mb-1">{item.title}</h4>
      ...
      {/* Subsection 2: Sadvidya Detail Grid */}
      <section className="adv-section mb-16 pt-8">
        <div className="container mx-auto px-4">
          <div className="row flex flex-wrap -mx-4 items-center flex-row-reverse">
            ...
            <div className="col-lg-8 w-full lg:w-2/3 px-4">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#cc0000] mb-4">2. Sadvidya – Traditional Education</h2>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { img: "Integrity.svg", title: "Integrity", desc: "The quality of being prudent by Intention, Attitude, behaviour & action. Develops good source" },
                  { img: "approve-1.png", title: "Gratitude", desc: "Instilling a sense of appreciation for blessings, fostering positive attitudes and generosity", path: "2022/08" },
      ...
      {/* Subsection 3: Brahmavidya Detail Grid */}
      <section className="adv-section mb-16 pt-8">
        <div className="container mx-auto px-4">
          <div className="row flex flex-wrap -mx-4 items-center">
            <div className="col-lg-4 w-full lg:w-1/3 px-4 mb-8 lg:mb-0 side-img-container">
            ...
            <div className="col-lg-8 w-full lg:w-2/3 px-4">
              <h2 className="text-2xl lg:text-3xl font-bold text-[#cc0000] mb-4">3. Brahmavidya – Spiritual Education</h2>
              <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  { img: "Realization-of-God.svg", title: "God Realization", desc: "Inspiring awareness of the divine presence within and around, guiding students towards spiritual enlightenment" },
                  { img: "leadership.svg", title: "Affection with Saints", desc: "Having strong emotional bond & unconditional affection with real Saints & Devotees. Inspiring students to emulate virtuous qualities in their lives." },
                  { img: "Self-Assesments-01.svg", title: "Self Realization", desc: "Awakening to one's true nature, fostering inner peace and fulfillment through personal discovery." },
                  { img: "Devotion.svg", title: "Devotion", desc: "Having immense love & affection for God with the devotional practices like chanting god’s name, seva, etc." },
      ...
      {/* Footer / Call to Action notes banner */}
      <section className="footer-notes mt-16 text-white py-12 mx-4 lg:mx-auto max-w-7xl">
          ...
          <div className="row flex flex-wrap -mx-4 items-center justify-between">
            <div className="col-lg-8 w-full lg:w-2/3 px-4 mb-6 lg:mb-0">
              <div className="notes-content">
                <h2 className="text-3xl font-extrabold mb-4 text-white">Admissions Open</h2>
...
export default GurukulValueSystem;
